...
// Array para almacenar las direcciones IP únicas
var uniqueIPs = [];
...
// Función para verificar si una dirección IP ya está en la lista
function isIPUnique(ip) {
  return !uniqueIPs.includes(ip);
}

// Función para agregar una dirección IP única al array
...
// Función para mostrar el número de direcciones IP únicas
function showUniqueIPCount() {
  console.log('Número de direcciones IP únicas:', uniqueIPs.length);
}

// Obtener la dirección IP del cliente y agregarla al array si es única
getIP().then(addUniqueIP);

// Mostrar el número de direcciones IP únicas en la consola
showUniqueIPCount();
